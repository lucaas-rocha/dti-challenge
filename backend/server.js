...
app.use(express.json()); // Allows the API to understand data sent in JSON format
...
app.put('/api/cart/:id', (req, res) => {
    ...
    // minimum quantity per product = 1, maximum quantity per product = 10
...
app.post('/api/checkout', (req, res) => {
    // I chose to simulate by removing every product from the cart
